...
CREATE TABLE IF NOT EXISTS "public"."layers" (
    ...
    "description" "text",
    CONSTRAINT "layers_owner_consistency_check" CHECK (((("owner_type" = 'system'::"text") AND ("owner_id" IS NULL)) OR (("owner_type" = 'community'::"text") AND ("owner_id" IS NOT NULL)) OR (("owner_type" = 'user'::"text") AND ("owner_id" IS NOT NULL)))),
...
CREATE POLICY "Authenticated users can create user layers" ON "public"."layers" FOR INSERT WITH CHECK ((("auth"."uid"() IS NOT NULL) AND ("owner_type" = 'user'::"text") AND ("owner_id" = "auth"."uid"())));
